...
public final class HotelCacheThreadSafe extends HotelCache {
	...
	/**
	 * Overrides addHotel method from HotelCache class to make it thread-safe; uses the lock.
	...
	/** Overrides toString method of class HotelCache to make it thread-safe.
	...
	public void printToFile(Path filename) {
		try {
			...
			log.error("Exception while running the printToFile ThreadSafe class: " + e);
		} finally { lock.unlockRead(); }
	}
