...
public final class WorkQueue {
    ...
    private final static int NUMBER_THREADS_DEFAULT = 10;
    ...
    /** Stop accepting new jobs. This method should not block until work is complete. */
